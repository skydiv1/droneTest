...
<div class="container">
	<a class="navbar-brand js-scroll-trigger" href="index.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DSM</a>
...
<div class="container">
	<div class="intro-text" style="padding-top:35px;">
		...
		<a id="login" class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#" style="padding: 7px 60px; box-shadow:0px 0px 10px #000; "><label style="width:100px; height:1px; ">로그인</label></a>
