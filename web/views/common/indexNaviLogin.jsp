...
<div class="container">
	<a class="navbar-brand js-scroll-trigger" href="#">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;DSM</a>
	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		<ul class="navbar-nav text-uppercase ml-auto">
			<li class="nav-item">
			<a class="nav-link js-scroll-trigger" href="#"><b>서비스 목록</b></a>
			</li>
			<li class="nav-item">
			<a class="nav-link js-scroll-trigger" href="views/member/enrollService.jsp"><b>서비스 등록</b></a>
			</li>
			<li class="nav-item">
...
<header class="masthead" style=" background-image: url('img/drone_background_login.png'); background-size: 100% 500px; margin-top: 0px; background-position:center;">
<div class="container">
	<div class="intro-text" style="padding-top:35px;">
		...
		<table style="margin-left:25%; width:500px; ">
         	<tr>
         		<td rowspan="2">
         			<img class="mx-auto rounded-circle" src="img/team/1.jpg" alt="" style=" width:120px; height:120px;" >
         		</td>
