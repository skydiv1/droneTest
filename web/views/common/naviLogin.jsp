...
<header class="masthead" style="background-image: url('/dsm/img/drone_background_login.png'); background-size: 100% 500px; margin-top: 0px; background-position:center;">
<div class="container">
